...
public class CardsAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        layoutCard.setBackground( CardUtils.getBackground(context, cards.get(position).getCardColor()) );
        imageViewSelectedFlag.setImageDrawable( CardUtils.getFlag(context, cards.get(position).getCardFlag()) );
